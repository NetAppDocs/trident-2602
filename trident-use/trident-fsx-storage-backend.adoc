...
The steps in this section cover how to create the backend separately. For information on how to use the Automatic Backend feature, refer to the link:trident-fsx-storageclass-pvc.html[Configure StorageClass and PVC] section for more information.
